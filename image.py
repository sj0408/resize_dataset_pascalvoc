...
def resize(image_path,
    ...
    for member in xmlRoot.findall('object'):
        ...
        xmin.text = str(int(np.round(int(float(xmin.text)) * scale_x)))
        ymin.text = str(int(np.round(int(float(ymin.text)) * scale_y)))
        xmax.text = str(int(np.round(int(float(xmax.text)) * scale_x)))
        ymax.text = str(int(np.round(int(float(ymax.text)) * scale_y)))
